...
import { AudioConfig, WebSocketMessage, ConfigMessage } from "../types";
...
class WebSocketHandler implements StreamHandler {
  ...
  private state = { isConfigured: false };
  ...
  private initialize(): void {
    this.ws.on("message", (msg) => this.handleMessage(msg as Buffer));
